package com.blackmirror.dongda.data.utils;

import android.content.pm.ApplicationInfo;
import android.text.TextUtils;
import android.util.Log;

import com.blackmirror.dongda.data.DataApp;

public class LogUtils {
    public static boolean DEBUG = (DataApp.me.getApplicationInfo().flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
