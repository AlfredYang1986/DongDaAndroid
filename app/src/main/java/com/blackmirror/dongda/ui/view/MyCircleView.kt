...
class MyCircleView @JvmOverloads constructor(
    ...
    var radius = DensityUtils.dp2px(7).toFloat()
    ...
    init {
        ...
        p1.strokeWidth = DensityUtils.dp2px(1).toFloat()
//        p1.color=Color.parseColor("#FFE0E0E0")
        p1.color = Color.parseColor("#FFE0E0E0")

        val d1 = DensityUtils.dp2px(8).toFloat()
        var d2 = DensityUtils.dp2px(8).toFloat()
