...
class EnrolAgeActivity : BaseActivity(), View.OnClickListener {
    ...
    private lateinit var cl_choose_low_age: ConstraintLayout
    private lateinit var tv_next: TextView
    private lateinit var tv_choose_low_age: TextView
    ...
    override val layoutResId: Int
        get() = R.layout.activity_enrol_age
    ...
    override fun initData() {
        ...
        pvCustomOptions = OptionsPickerBuilder(this, OnOptionsSelectListener { options1, options2, options3, v ->
            ...
            logD("ageMin: $min  ageMax: $max options3=$options3")
            tv_choose_low_age.text = min
            tv_choose_low_age.setTextColor(Color.parseColor("#FF404040"))
            tv_choose_low_age.textSize = 22f

            tv_choose_large_age.text = max
            tv_choose_large_age.setTextColor(Color.parseColor("#FF404040"))
            tv_choose_large_age.textSize = 22f
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.tv_next -> {
                ...
                val intent = Intent(this@EnrolAgeActivity, EnrolClassNumActivity::class.java)
            ...
            R.id.cl_choose_low_age -> {
                pvCustomOptions!!.setSelectOptions(0, 0)
                pvCustomOptions!!.show()
            }
            R.id.cl_choose_large_age -> {
                pvCustomOptions!!.setSelectOptions(0, 0)
                pvCustomOptions!!.show()
            }
        }
