...
class CustomDialog3 : Dialog {
    ...
    class Builder(val context: Context) {
        ...
        fun build(): CustomDialog3 {
            return CustomDialog3(this, R.style.CustomDialog)
        }

        fun build(style: Int): CustomDialog3 {
            return CustomDialog3(this, style)
        }
