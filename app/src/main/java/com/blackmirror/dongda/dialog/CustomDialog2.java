...
public class CustomDialog2 extends Dialog {
    ...
    protected CustomDialog2(Builder builder, int resStyle) {
    ...
    protected CustomDialog2(Builder builder) {
    ...
    public static final class Builder {
        ...
        public CustomDialog2 build() {
            return new CustomDialog2(this, R.style.CustomDialog);
        }

        public CustomDialog2 build(int style) {
            return new CustomDialog2(this, style);
        }
