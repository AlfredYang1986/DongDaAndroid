...
public class HomeScienceAdapter extends RecyclerView.Adapter<HomeScienceAdapter.HomeScienceViewHolder> {
    ...
    public void onBindViewHolder(HomeScienceViewHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(bean.services.get(position).operation.get(0))){
            ...
            holder.tv_item_science_name.setText(bean.services.get(position).operation.get(0));
        }
        ...
        holder.tv_item_science_location.setText(servicesBean.address.substring(0,servicesBean.address.indexOf(context.getString(R.string.str_qu))+1));
