...
/**
 * Created by Ruge on 2018-04-08 下午3:59
 */
public class FeaturedDetail2Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FeaturedDetail2Adapter() {
    }

    public FeaturedDetail2Adapter(RecyclerView.Adapter innerAdapter) {
